...
const Navbar = () => {
  ...
  return (
    <div
      className={cn(
        "w-full full fixed top-0 inset-x-0 transition-all duration-300",
        isScrolled ? "bg-blue-50/90 shadow-lg z-50" : "bg-transparent"
      )}
    >
      <div
        className={cn("max-w-7xl mx-auto px-4 md:px-8 py-5 grid grid-cols-12 ")}
      >
